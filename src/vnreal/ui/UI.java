...
import vnreal.ui.menu.FileMenu;
import vnreal.ui.menu.GeneratorMenu;
import vnreal.ui.menu.HelpMenu;
import vnreal.ui.menu.MetricsMenu;
import vnreal.ui.menu.ViewMenu;
import vnreal.ui.utils.MySelectionTreeModel;
...
public final class UI extends Ui {
	/**
	...
	public UI(Scenario scenario) {
		...
		scenario.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				graphpanel.setLayerStack(UI.this.scenario.getNetworkStack());
			}
		});
