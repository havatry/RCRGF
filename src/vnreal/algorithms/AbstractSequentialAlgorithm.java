...
/**
 * Implements design pattern "template method" in method {@link #evaluate()} for
...
public abstract class AbstractSequentialAlgorithm<P> extends AbstractAlgorithm {
	 ...
	 * @return true to continue, false to interrupt the algorithm.
	 */
	protected abstract boolean process(final P p);
